                ...
                <form wire:submit.prevent="update">
                    ...
                    <div class="card border border-danger">
                        <div class="card-header alert-danger">
                            <h5><i class="fa fa-book"></i> Update Subject</h5>
                        </div>
                        <div class="card-body" >
                            ...
                            <div class="row" style="margin-top: 10px">
                                <div class="col-sm-2">
                                    <button class="btn btn-primary mt-auto" type="submit" name="submit">Update Subject</button>
                                </div>
                                <div class="col-sm-2">
                                    <button class="btn btn-danger mt-auto" wire:click.prevent="togglePage" type="submit" name="submit">Add Subject</button>
                                </div>
                            </div>
                        </div>
                    </div>
